package annotations.task11.service;

import annotations.task11.annotations.Test;
import annotations.task11.annotations.TestNote;
import annotations.task11.annotations.TestObjectCleanup;
import annotations.task11.annotations.TestObjectCreate;
...
// Synthesized default constructor; OK
        ...
        for (Method m : testMethods) {
            ...
            if(m.isAnnotationPresent(TestNote.class)) // if @TestNote present
                System.out.println("Note: " + m.getAnnotation(TestNote.class).note());
            try {
